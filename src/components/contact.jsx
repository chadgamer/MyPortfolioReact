...
function Contact() {
    return (
        <section class="py-10 bg-[#020203] sm:py-16 lg:py-24 relative row-start-7">
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="max-w-5xl mx-auto mt-12 sm:mt-16 z-10 relative">
            <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                <div class="overflow-hidden bg-[#030405] rounded-xl">
                    <div class="p-6">
            ...
            <div class="mt-6 overflow-hidden bg-[#030405] rounded-xl">
